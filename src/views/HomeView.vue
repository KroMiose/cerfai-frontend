          ...
          <el-row :gutter="10">
            <el-col :xs="24" :sm="24" :md="18" :lg="16" :xl="16">
              <el-alert
                title="参与贡献说明"
                type="info"
                description="您所看到的所有词条内容来自机器翻译/人工初筛/其他用户个人上传，欢迎对词条进行内容审核或者参与实际测试并提供宝贵的建议。如果您认为该词条准确无误，请点击提交，将自动随机下一条标签；输入词条分类关键词，可以快速选择词条分类。如果该词条没有适合的分类，请输入并选择 “标签扩展” 并可在备注中描述新的分类。如果经多方测试，标签无效或者当前版本无效，请输入并选择“无效标签”。如果您对当前标签没兴趣或者不需要进行修改，点击“换一个”更换词条。"
                show-icon
              >
              </el-alert>
              <el-form
              ...
              >
                ...
                <el-form-item label="是否NSFW：" prop="is_nsfw">
                  ...
                  >
                  <span class="nsfw-span" v-show="!form.is_nsfw"
                    >这是一个任何场所安全的词条</span
                  >
                </el-form-item>
