    ...
    <div class="table-view">
      ...
      >
        ...
        >
          <template v-slot="scope">
            <el-tooltip
              class="item"
              effect="dark"
              :content="tableData[scope.$index].t_name"
              placement="top-start"
            >
              <span class="s_name_dsp">{{
                tableData[scope.$index].t_name
              }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        >
          <template v-slot="scope">
            <span
              v-text="get_category_name(tableData[scope.$index].c_id)"
            ></span>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template v-slot="scope">
            <el-tooltip
              class="item"
              effect="dark"
              :content="tableData[scope.$index].desc"
              placement="top-start"
            >
        ...
        >
          <template v-slot="scope">
            <el-tooltip
              class="item"
              effect="dark"
              :content="tableData[scope.$index].remarks"
              placement="top-start"
            >
              <span class="s_name_dsp">{{
        ...
        >
          <template v-slot="scope">
            <el-tooltip
              class="item"
              effect="dark"
              :content="tableData[scope.$index].contributor"
              placement="top-start"
            >
              <span class="s_name_dsp">{{
                tableData[scope.$index].contributor
              }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        >
          <template v-slot="scope">
            <el-tag v-if="tableData[scope.$index].is_nsfw" type="danger"
              >NSFW</el-tag
            >
        ...
        >
          <template v-slot="scope">
            <el-tag v-if="tableData[scope.$index].is_locked" type="warning"
              >已锁定</el-tag
            >
    ...
    >
      <div class="drawer">
        ...
        >
          ...
          <!-- Qzhihe 2022-10-26 -->
          <template slot="extra">
            <!-- TODO: click 事件应调用 API 实现词条删除 -->
            <el-button type="danger" size="small" @click="null">删除</el-button>
          </template>
          <!--  -->

          <el-descriptions-item>
            <template slot="label"
              ><i class="el-icon-mobile-phone"></i>词条名</template
            >
            {{ selRowData.name }}
          </el-descriptions-item>
          ...
          <el-descriptions-item span="1">
            ...
            <el-input placeholder="请输入词条译名" v-model="selRowData.t_name">
            </el-input>
          </el-descriptions-item>

          <el-descriptions-item>
            <template slot="label"
              ><i class="el-icon-s-custom"></i>是否NSFW</template
            >
            <el-switch
              style="display: block"
          ...
          <el-descriptions-item>
            <template slot="label"
              ><i class="el-icon-key"></i>是否锁定</template
            >
            <el-switch
              style="display: block"
          ...
          <el-descriptions-item>
            <template slot="label"
              ><i class="el-icon-headset"></i>上次更新时间</template
            >
          ...
          <el-descriptions-item>
            <template slot="label"
              ><i class="el-icon-star-off"></i>更新总次数</template
            >
          ...
          <el-descriptions-item span="2">
            ...
            <category-selector
              :value="selRowData.c_id"
              @change="(nv) => (selRowData.c_id = nv)"
            ></category-selector>
          </el-descriptions-item>
